...
from app.modules.posts.schemas import CreatePostRequest, FeedPostResponse, PostMediaResponse, PostResponse
...
async def _enrich_to_feed_responses(
    ...
    """Enrich a list of Post objects with counts, interaction flags, and author info."""
    if not posts:
        return []
